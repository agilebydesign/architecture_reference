// e2e/adapters/webview_behavior_adapter.ts — IBehavior implementation via WebView DOM
import { browser, $, $$ } from "@wdio/globals";
import type { WebView } from "wdio-vscode-service";
import type { IBehavior, IBehaviorConfig, IActionConfig, IBaseActionConfig, BehaviorHydrateData, ExecutionSetting, NavigationResult, PositionResult } from "../../../src/behavior/behavior";
import { botBehaviorLocators } from "../pageobjects/locators";

/**
 * Wraps WebView DOM as IBehavior for E2E tests.
 ...
 */
export class WebViewBehaviorAdapter implements IBehavior {
  ...
  hydrate(_data?: BehaviorHydrateData): void {
    // No-op for E2E
  }
}
