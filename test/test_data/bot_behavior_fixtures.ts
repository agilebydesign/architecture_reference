// test/test_data/bot_behavior_fixtures.ts — Shared fixture data for bot_behavior tests
// Used by both bot_behavior_test.ts (unit/integration) and bot_behavior_webview.e2e.ts (e2e).
import type { IBehaviorConfig, IBaseActionConfig, IActionConfig } from "../../src/bot_behavior/bot_behavior.js";
...
/**
 * Pre-computed persistence fixture: the execution state BotBehaviorServer._save() would produce.
 * Used by e2e tests to seed persistence/bot_behavior.json before opening the webview.
 * Note: persistence now only stores execution state, not full configs/instructions.
 */
