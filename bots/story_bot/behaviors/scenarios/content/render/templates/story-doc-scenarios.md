...
**Location:** `docs/story/map/{epic_name}/{feature_name}/{story_name}.md`  
**Folder Structure:** Uses emoji monikers: 🎯 for Epic folders, ⚙️ for Feature folders  
**Example:** `docs/story/map/🎯 Manage Mobs/⚙️ Create Mob/📝 Select Minion Tokens.md`  
**Content:**
...
**Generated by:** specification_scenarios stage  
**Location:** `docs/story/{epic_name}/{feature_name}/structured.json`  
**Content:**
